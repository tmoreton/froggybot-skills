...
2. **Social Creative** — turn a Trend Scout or user brief into draft social copy, memes, and images with human review. Meme-only work can remain group-safe; selecting Image Generator makes the bot ineligible for group replies and group schedules and introduces the same direct-turn approval behavior.
